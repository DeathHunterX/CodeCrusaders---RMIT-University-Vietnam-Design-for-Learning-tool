...
import { FaCamera, FaFacebook, FaLink, FaLinkedin, FaTwitter } from 'react-icons/fa'
...
const ProfileComponent = () => {
    const initialState = {
        fullName: "", displayName: "", address: "", description: ""
    }

    const [userData, setUserData] = useState(initialState)
    const { fullName, displayName, address, description } = userData
    ...
    return (
        <div className="edit_profile px-4">
            <div className="d-flex justify-content-between">
                <h4>Phan Thanh Loi's Profile</h4>
                <div className="">
                    <button className="btn"><BsPencilSquare/> Edit</button>
                </div>
            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="form_group mb-3 col-md-6">
                                ...
                                <div className="position-relative">
                                    ...
                                    name="displayName" value={displayName} onChange={handleInput} />
                                </div>
                            </div>
